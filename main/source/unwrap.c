 ...
 */
graphe_struct_Louis deserialise_Graph(FILE * dbxmlCache, FILE * auteurCache, FILE * ArticleCache){
    ...
    graphe_struct_Louis graph  = {mes_auteur, mes_Article,mesfiche};
    return graph;
}

graphe_struct_Louis gen_Graph_from_XML(FILE * dbxmlCache){
...
void serialise_Graph(graphe_struct_Louis graph, FILE * dbxmlCache, FILE * auteurCache, FILE * ArticleCache){
...
void free_Graph_struct(graphe_struct_Louis afree){
