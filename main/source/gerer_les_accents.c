                        ...
                        if(nom_illisible[i+4]=='a'  )
                        {
                            if(nom_illisible[i+5]=='v'  )
                            {
                                if(nom_illisible[i+6]=='e'  )
                                {
                                    ...
                                    {
                                        make_decode_string('A', nom_illisible, i, i+8);
                                    }
                                }
                            }
                        }
                    ...
                    if(nom_illisible[i+3]=='i')
                    {
                        if(nom_illisible[i+4]=='r'  )
                        {
                            if(nom_illisible[i+5]=='c'  )
                            {
                                ...
                                {
                                    //replace("&Acirc;", 'Â')
                                    make_decode_string('A', nom_illisible, i, i+7);
                                }    
                            }
                        }
                    }  
                ...
                if(nom_illisible[i+2]=='u')
                {
                    if(nom_illisible[i+3]=='m'  )
                    {
                        ...
                        {   
                            ...
                            {     
                                //replace("&Auml;", 'Ä') 
                                make_decode_string('A', nom_illisible, i, i+6);     
                            }   
                        }      
                    }     
                }
                        ...
                        if(nom_illisible[i+4]=='a'  )
                        {
                            if(nom_illisible[i+5]=='v'  )
                            {
                                if(nom_illisible[i+6]=='e'  )
                                {
                                    ...
                                    {
                                        //replace("&Egrave;", 'È')
                                        make_decode_string('E', nom_illisible, i, i+8);
                                    }
                                }
                            }
                        }
                    ...
                    if(nom_illisible[i+3]=='i')
                    {
                        if(nom_illisible[i+4]=='r'  )
                        {
                            if(nom_illisible[i+5]=='c'  )
                            {
                                ...
                                {
                                    //replace("&Ecirc;", 'Ê')
                                    make_decode_string('E', nom_illisible, i, i+7);
                                }    
                            }
                        }
                    }  
                ...
                if(nom_illisible[i+2]=='u')
                {
                    if(nom_illisible[i+3]=='m'  )
                    {
                        ...
                        {   
                            ...
                            {     
                                //replace("&Euml;", 'Ë')  
                                make_decode_string('E', nom_illisible, i, i+6);    
                            }   
                        }      
                    }     
                }      
                        ...
                        if(nom_illisible[i+4]=='a'  )
                        {
                            if(nom_illisible[i+5]=='v'  )
                            {
                                if(nom_illisible[i+6]=='e'  )
                                {
                                    ...
                                    {
                                        //replace("&Igrave;", 'Ì')
                                        make_decode_string('I', nom_illisible, i, i+8);    
                                    }
                                }
                            }
                        }
                    ...
                    if(nom_illisible[i+3]=='i')
                    {
                        if(nom_illisible[i+4]=='r'  )
                        {
                            if(nom_illisible[i+5]=='c'  )
                            {
                                ...
                                {
                                    //replace("&Icirc;", 'Î')
                                    make_decode_string('I', nom_illisible, i, i+7);
                                }    
                            }
                        }
                    }  
                ...
                if(nom_illisible[i+2]=='u')
                {
                    if(nom_illisible[i+3]=='m'  )
                    {
                        ...
                        {   
                            ...
                            {     
                                //replace("&Iuml;", 'Ï')
                                make_decode_string('I', nom_illisible, i, i+6);      
                            }   
                        }      
                    }     
                }             
                        ...
                        if(nom_illisible[i+4]=='a'  )
                        {
                            if(nom_illisible[i+5]=='v'  )
                            {
                                if(nom_illisible[i+6]=='e'  )
                                {
                                    ...
                                    {
                                        //replace("&Ograve;", 'Ò')
                                        make_decode_string('O', nom_illisible, i, i+8);  
                                    }
                                }
                            }
                        }
                    ...
                    if(nom_illisible[i+3]=='i')
                    {
                        if(nom_illisible[i+4]=='r'  )
                        {
                            if(nom_illisible[i+5]=='c'  )
                            {
                                ...
                                {
                                    //replace("&Ocirc;", 'Ô')
                                    make_decode_string('O', nom_illisible, i, i+7);  
                                }    
                            }
                        }
                    }  
                ...
                if(nom_illisible[i+2]=='u')
                {
                    if(nom_illisible[i+3]=='m'  )
                    {
                        ...
                        {   
                            ...
                            {     
                                //replace("&Ouml;", 'Ö') 
                                make_decode_string('O', nom_illisible, i, i+6);     
                            }   
                        }      
                    }     
                }
                        ...
                        if(nom_illisible[i+4]=='a'  )
                        {
                            if(nom_illisible[i+5]=='v'  )
                            {
                                if(nom_illisible[i+6]=='e'  )
                                {
                                    ...
                                    {
                                        //replace("&Ugrave;", 'Ù')
                                        make_decode_string('U', nom_illisible, i, i+8);
                                    }
                                }
                            }
                        }
                    ...
                    if(nom_illisible[i+3]=='i')
                    {
                        if(nom_illisible[i+4]=='r'  )
                        {
                            if(nom_illisible[i+5]=='c'  )
                            {
                                ...
                                {
                                    //replace("&Ucirc;", 'Û')
                                    make_decode_string('U', nom_illisible, i, i+7);
                                }    
                            }
                        }
                    }  
                ...
                if(nom_illisible[i+2]=='u')
                {
                    if(nom_illisible[i+3]=='m'  )
                    {
                        ...
                        {   
                            ...
                            {     
                                //replace("&Uuml;", 'Ü') 
                                make_decode_string('U', nom_illisible, i, i+6);     
                            }   
                        }      
                    }     
                }                    
                        ...
                        if(nom_illisible[i+4]=='u'  )
                        {
                            if(nom_illisible[i+5]=='t'  )
                            {
                                if(nom_illisible[i+6]=='e'  )
                                {
                                    ...
                                    {
                                        //replace("&Yacute;", 'Ý')
                                        make_decode_string('Y', nom_illisible, i, i+8); 
                                    }
                                }
                            }
                        }
                ...
                if(nom_illisible[i+2]=='u')
                {
                    if(nom_illisible[i+3]=='m'  )
                    {
                        ...
                        {   
                            ...
                            {     
                                //replace("&Yuml;", 'Ÿ') 
                                make_decode_string('Y', nom_illisible, i, i+6);      
                            }   
                        }      
                    }     
                }           
                        ...
                        if(nom_illisible[i+4]=='d'  )
                        {
                            if(nom_illisible[i+5]=='i'  )
                            {
                                if(nom_illisible[i+6]=='l'  )
                                {
                                    ...
                                    {
                                        //replace("&Ccedil;", 'Ç')
                                        make_decode_string('c', nom_illisible, i, i+8); 
                                    }
                                }
                            }
                        }
                    ...
                    if(nom_illisible[i+3]=='O')
                    {
                        if(nom_illisible[i+4]=='R')
                        {
                            if(nom_illisible[i+5]=='N')
                            {
                                ...
                                {
                                    //replace("&THORN;";, 'Þ')
                                    make_decode_string('p', nom_illisible, i, i+7); 
                                }
                        ...
                        if(nom_illisible[i+4]=='l'  )
                        {
                            if(nom_illisible[i+5]=='d'  )
                            {
                                if(nom_illisible[i+6]=='e'  )
                                {
                                    ...
                                    {
                                        //replace("&Ntlde;", 'Ñ')
                                        make_decode_string('N', nom_illisible, i, i+8);
                                    }
                                }
                            }
                        }
            ...
            if(nom_illisible[i+1]=='y')
            {
                if(nom_illisible[i+2]=='e'  )
                {
                    ...
                    {   
                        ...
                        {     
                            //replace("&yen;", '¥') 
                            make_decode_string('y', nom_illisible, i, i+4);       
                        }   
                    }      
                }
                if(nom_illisible[i+2]=='a')
                ...
                if(nom_illisible[i+2]=='e'  )
                {
                    if(nom_illisible[i+3]=='n')
                    {
                        if(nom_illisible[i+4]=='t')
                        {
                            ...
                            {   
                                //replace("&cent;", '¢') 
                                make_decode_string('c', nom_illisible, i, i+6);  
                            }
                        }
                    }
                }
