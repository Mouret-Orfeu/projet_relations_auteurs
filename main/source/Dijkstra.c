...
void print_chemins_auteur_et_Article(plus_court_chemin_struct* pcc)
{
    ...
    //graphe_struct_Orfeu mon_graphe= faire_graphe_ptr_auteur();
...
plus_court_chemin_struct* relachement_de_arretes_jusqu_a_trouver_ou_tout_parcourir(auteur_struct* ptr_auteur_depart, auteur_struct* ptr_auteur_destination, char* nom_auteur_depart, graphe_struct_Orfeu graphe_t);
...
plus_court_chemin_struct* do_Dijkstra(graphe_struct_Orfeu graphe_t, char* nom_auteur_depart, char* nom_auteur_destination)
{
...
void free_Dijkstra(graphe_struct_Orfeu graphe_struct, plus_court_chemin_struct *pcc_ptr)
{
    INFO("Free Dijkstra ")
    if(pcc_ptr!= NULL)
    {  
