...
graphe_struct_Louis faire_graphe_Louis(char * DBfiche, char * DBauteur, char * DBArticle)
{
    ...
    graphe_struct_Louis graphe_Louis = deserialise_Graph(DBficheLecture
                                    ,DBauteurLecture
                                    ,DBArticleLecture);
...
//faire le graphe (tableau) des pointeurs vers les auteurs, ce que je vais appeler ensuite graphe_Orfeu
graphe_struct_Orfeu faire_graphe_ptr_auteur( graphe_struct_Louis graphe_Louis)
{

    int size_graphe= graphe_Louis.tab_auteur_struct.nombre_auteur;
    graphe_struct_Orfeu graphe_struct;
    ...
    {
        auteur_struct* ai_ptr= &(graphe_Louis.tab_auteur_struct.tab_auteur[i]);
        ai_ptr->size_pcc_auteur= -1;
        graphe_struct.graphe[i]= ai_ptr;           
    }
    graphe_struct.nb_auteurMax = graphe_Louis.tab_auteur_struct.nombre_auteur;
    return graphe_struct;
}


void voir_si_un_auteur_est_dans_le_graphe_et_donner_un_Article_ou_il_apparait(graphe_struct_Orfeu graphe_struct, char* nom_auteur)
{
...
void donner_tous_les_Articles_de_auteur(graphe_struct_Orfeu graphe_struct, char* nom_auteur)
{
    comparaison_auteur trouver_ou_pas= auteur_pas_trouver;
    auteur_struct* ptr_auteur= NULL;
...
void donner_tous_ceux_qui_ont_travalle_avec_auteur(graphe_struct_Orfeu graphe_struct, char* nom_auteur)
{
    comparaison_auteur trouver_ou_pas= auteur_pas_trouver;
    auteur_struct* ptr_auteur= NULL;
...
void print_noms_des_voisins(graphe_struct_Orfeu graphe_t, char* nom_auteur)
{
