...
typedef struct graphe_struct_Orfeu
{
...
/**
 * @brief Crée un tableau de pointeur vers les auteur_struct du graphe_Louis, crée dans la fonction "faire_graphe_Louis".
 * Ce tableau de pointeur pourra être appelé graphe_Orfeu
 * 
 * @param graphe_Louis 
 * @return graphe_struct_Orfeu 
 */
